...
#ifndef MESHRED_SWIFT_H
#define MESHRED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MeshRed",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC7MeshRed14NetworkManager")
...
@class NSData;
@class MCSession;
@interface NetworkManager (SWIFT_EXTENSION(MeshRed)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface NetworkManager (SWIFT_EXTENSION(MeshRed)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface NetworkManager (SWIFT_EXTENSION(MeshRed)) <MCSessionDelegate>
